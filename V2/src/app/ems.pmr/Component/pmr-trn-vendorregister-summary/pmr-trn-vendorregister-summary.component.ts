...
export class PmrTrnVendorregisterSummaryComponent {
  ...
  constructor(public service :SocketService,private excelService : ExcelService,private route:Router,private ToastrService: ToastrService,private NgxSpinnerService:NgxSpinnerService) {
