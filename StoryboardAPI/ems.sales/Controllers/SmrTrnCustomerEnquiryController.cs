...
namespace ems.sales.Controllers
{
    ...
    public class SmrTrnCustomerEnquiryController : ApiController
    {
        ...
        [HttpGet]
        public HttpResponseMessage GetEditProductsSummary(string enquiry_gid)
        {
            MdlSmrTrnCustomerEnquiry values = new MdlSmrTrnCustomerEnquiry();
            objsales.DaGetEditProductsSummary(enquiry_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        ...
        public HttpResponseMessage PostEditOnAdds(productsummarys_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objsales.DaPostEditOnAdds(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        [HttpGet]
        public HttpResponseMessage GetDeleteEnquiryEditProductSummary(string tmpsalesenquiry_gid)
        {
            productsummarys_list objresult = new productsummarys_list();
            objsales.DaGetDeleteEnquiryEditProductSummary(tmpsalesenquiry_gid, objresult);
            return Request.CreateResponse(HttpStatusCode.OK, objresult);
        }
       ...
       // Post Proposal
        ...
        [ActionName("GetEditEnquirySummary")]
        [HttpGet]
        public HttpResponseMessage GetEditEnquirySummary(string enquiry_gid)
        {
            MdlSmrTrnCustomerEnquiry objresult = new MdlSmrTrnCustomerEnquiry();
            objsales.DaGetEditEnquirySummary(enquiry_gid, objresult);
            return Request.CreateResponse(HttpStatusCode.OK, objresult);
        }
