...
namespace ems.payroll.DataAccess
{
    public class DaPayTrnSalaryManagement
    {
        ...
        OdbcDataReader objMySqlDataReader, objMySqlDataReader1, objMySqlDataReader2, objMySqlDataReader3;
                ...
                foreach (var data in values.employeeleave_list)
                {
                    ...
                    if (objMySqlDataReader1.HasRows == true)
                    {
...

                        {
                            ...
                            OdbcDataReader objMySqlDataReader4 = objdbconn.GetDataReader(msSQL1);
