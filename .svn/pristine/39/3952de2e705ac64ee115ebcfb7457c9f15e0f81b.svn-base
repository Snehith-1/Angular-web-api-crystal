...
namespace ems.sales.DataAccess
{
    public class DaSmrTrnSalesorder
    {
        ...
        public void DaGetViewsalesorderSummary(string salesorder_gid, MdlSmrTrnSalesorder values)
        {
            try
            {
                ...
                msSQL = " SELECT distinct a.salesorder_gid, h.currency_code, a.customerbranch_gid, a.exchange_rate, " +
                    ...
                    " a.termsandconditions, a.shipping_to, a.customer_mobile, a.customer_email, e.branch_name, " +
                    " FORMAT(a.total_amount, 2) AS total_amount, FORMAT(a.freight_charges, 2) AS freight_charges, " +
                    " FORMAT(a.packing_charges, 2) AS packing_charges,a.total_price, FORMAT(a.buyback_charges, 2) AS buyback_charges, " +
        ...
        public void DaGetViewsalesorderdetails(string salesorder_gid, MdlSmrTrnSalesorder values)
        {
            try
            {

                msSQL = " select d.product_name,d.product_code,d.uom_name,d.qty_quoted,d.margin_amount,d.margin_percentage," +
                    "FORMAT(d.product_price, 2) AS product_price ,d.tax_name,d.tax_amount,FORMAT(d.price, 2) AS price " +
...
//" LEFT JOIN adm_mst_tuser b ON b.user_gid = e.created_by GROUP BY e.currency_code ";
        ...
        public void DaAmendSalesOrder(string employee_gid, Getamendsalesorderdtl1 values)
        {
            ...
            else
            {
                ...
                if (objOdbcDataReader.HasRows == true)
                {
                    ...
                    msSQL = " INSERT INTO crm_mst_tcustomer " +
                        ...
                        "'N'," +
                        " 'Active', " +
                        "'" + objOdbcDataReader["created_flag"] + "')";
                    ...
                    if (objOdbcDataReader.HasRows == true)
                    {
                        while (objOdbcDataReader.Read())
                        {
                            ...
                            msSQL = " INSERT INTO crm_mst_tcustomercontact " +
                                    ...
                                    "'" + DateTime.Now.ToString("yyyy-MM-dd") + "'," +
                                    "'" + employee_gid + "'," +
                                    "'" + objOdbcDataReader["address1"] + "'," +
                                    "'" + objOdbcDataReader["address2"] + "'," +
                                    "'" + objOdbcDataReader["state"] + "'," +
                                    "'" + objOdbcDataReader["country_gid"] + "'," +
                                    "'" + objOdbcDataReader["city"] + "'," +
                                    "'" + objOdbcDataReader["region_name"] + "',," +
                                    "'" + objOdbcDataReader["pincode"] + "'," +
                                    "'" + objOdbcDataReader["leadbankbranch_name"].ToString() + "'," +
                            ...
                            if (mnResult2 == 1)
                            {
                                msSQL = " update crm_trn_tleadbankcontact set," +
                                    ...
                                    " where leadbankcontact_gid = '" + objOdbcDataReader["leadbankcontact_gid"]+ "'";
            ...
            objOdbcDataReader = objdbconn.GetDataReader(msSQL);
            lsamend_count = objOdbcDataReader.RecordsAffected;
            ...
            if (objOdbcDataReader.HasRows == true)
            {
                lsstatus = objOdbcDataReader["salesorder_status"].ToString();
                hsnso_referencenumber = objOdbcDataReader["so_referencenumber"].ToString();
            }
            objOdbcDataReader.Close();
