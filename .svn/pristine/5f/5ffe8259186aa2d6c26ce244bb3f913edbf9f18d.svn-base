...
export class CrmSmmWatsappComponent implements OnInit {
  ...
  public onupdatecontact(): void {
    if (this.reactiveFormContactEdit.value.displayName_edit != null && this.reactiveFormContactEdit.value.phone_edit.e164Number != null && this.reactiveFormContactEdit.value.customertype_edit != null) {
