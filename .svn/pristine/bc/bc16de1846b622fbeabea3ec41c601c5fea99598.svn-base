    ...
    public class DaWhatsapp
    {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = "insert into crm_trn_tfiles(" +
                                ...
                                "'" + ConfigurationManager.AppSettings["blob_imagepath1"] + final_path + msdocument_gid + FileExtension + ConfigurationManager.AppSettings["blob_imagepath2"] +
                                                           ...
                                                           '&' + ConfigurationManager.AppSettings["blob_imagepath6"] + '&' + ConfigurationManager.AppSettings["blob_imagepath7"] + '&' + ConfigurationManager.AppSettings["blob_imagepath8"] + "')"; mnResult1 = objdbconn.ExecuteNonQuerySQL(msSQL);
                        if (mnResult1 == 1)
                        {
        ...
        public void DaGetMessage(MdlWhatsapp values, string whatsapp_gid)
        {
            try
            {
                ...
                msSQL = "SELECT a.message_id,a.project_id,d.template_body,d.footer,d.media_url,a.created_date,a.direction,a.contact_id,b.lastName,b.firstName, a.message_text,a.type,a.status," +
        ...
        public void DaGetcampaign(MdlWhatsapp values)
        {
            try
            {
                ...
                msSQL = "SELECT distinct(a.project_id),a.campaign_flag, a.version_id, a.p_type, a.p_name, DATE_FORMAT(a.created_date, '%d-%m-%Y') AS created_date," +
